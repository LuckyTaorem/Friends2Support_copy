<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	...
	<body>
		<% if(session.getAttribute("userid")==null){ session.invalidate(); response.sendRedirect("main.jsp?q=logout"); }
			%>
			<div id="result_container">
				...
				if(request.getParameter("q")!=null){ 
					...
					switch(q){ 
					case "success" :
						out.println("<h3 class='alert_success'>Welcome back, "+session.getAttribute("username")+"</h3>");
						break;
					case "account_deleted":
						out.println("<h3 class='alert_danger'>Account with username("+session.getAttribute("username")+")has been deleted</h3>");
						break;
					case "lastDonate":
						out.println("<h3>Your Last Blood Donate has been recorded!</h3>");
						break;
					}
				}
					%>
					<div id="result_top">
						<a href="mypage.jsp"><img src="../images/main_logo.gif" style="float:left;"></a>
					...
					<div id="result_right">
						<div id="result_right_top">
							<div id="top"><a style="color:white;">&#9654;</a> <a>My Page</a>
							</div>
							<div id="register">
								<table id="mypage">
									<tr>
										...
										<td><a href="LastDonated.jsp">Last Donated Blood</a></td>
										<td><a href="delete_profile.jsp">Delete Profile/Unsubscribe</a></td>
									</tr>
								</table>
							</div>
						</div>
