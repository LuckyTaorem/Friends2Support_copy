		...
		<div id="result_container">
			...
			<div id="result_right" style="width:665px;">
				<div id="result_right_top">
					<div id="top"><a style="color:white;">&#9654;</a> <a>People Behind : Founders</a>
					</div>
					<div id="aboutus">
						<div id="text" style="line-height:15px;">
							<ol id="right_ul" class="ul_gap">
								<li>
									<b>Shareef. Sk</b><br>
									Hyderabad<br>
									<a href="mailto:shareef@friendstosupport.org">shareef@friendstosupport.org</a>
								</li>
								<li>
									<b>Naveen. E</b><br>
									Software Engineer, U. S. A<br>
								</li>
								<li>
									<b>K.eswar S</b><br>
									Software Engineer, U. S. A<br>
								...
								<li>
									<b>Murali Krishna. M</b><br>
									Design Engineer, Singapore<br>
									<a
										href="mailto:muralikrishna@friendstosupport.org">muralikrishna@friendstosupport.org</a>
								</li>
							</ol>
							<br>
							<b>Co-Founders</b>
							...
							<ol id="right_ul" class="ul_gap">
								<li>
									<b>Naresh. M</b><br>
									Hyderabad<br>
									<a href="mailto:naresh@friendstosupport.org">naresh@friendstosupport.org</a>
								</li>
								<li>
									<b>vijay. P</b><br>
									Software Engineer, Hyderabad<br>
									<a
										href="mailto:vijay.pothireddy@friendstosupport.org">vijay.pothireddy@friendstosupport.org</a>
								</li>
							</ol>
						</div>
					</div>
