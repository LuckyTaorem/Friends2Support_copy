		...
		<div id="result_container">
			...
			<div id="result_right" style="width:665px;">
				<div id="result_right_top">
					<div id="top"><a style="color:white;">&#9654;</a> <a>Invite your friends</a>
					</div>
					<div id="aboutus">
						<div id="text" style="line-height:15px;">
							Let your friends know about this cause and you want them too to join this life saviours
							group(blood donors)?
							<br><br>
							<p style="text-align:center;background:#bebebe;font-weight:bold;padding:5px;">Simply invite
								all your contacts of</p>
							<div id="img_link">
								<a href="https://google.com/"><img src="../images/google_logo.png"></a>
								<a href="https://in.search.yahoo.com/"><img src="../images/yahoo_logo_in.png"></a>
