		...
		<div id="result_container">
			...
			<div id="result_right" style="width:665px;">
				<div id="result_right_top">
					<div id="top"><a style="color:white;">&#9654;</a> <a>Journey : Vision, Mission and values</a>
					</div>
					<div id="aboutus">
						<div id="text" style="line-height:15px;">
							...
							<br><br>
							<ul id="right_ul">
								<li>Safer, by bringing blood donors and those in need to a common platform.</li>
								<li>Better, by providing every person what he/she deserves the most, best education.
								</li>
							</ul>
							<br><br>
							...
							<ul id="right_ul">
								...
								<li>To set up a well organised infrastructure through out the country to cater to the
									education of the under resourced by way of maintaining a repository of contributed
									books and providing as many resources as possible for rural child education.</li>
							</ul>
							<br><br>
							<b>Mission</b> :
							<br><br>
							To make the best use of contemporary technologies in delivering a promising web portal to
							bring together all the blood donors in India; thereby fulfilling every blood request in the
							country.
							<br><br>
							To provide a common platform for those who have a zeal to support education of the under
							resourced yet meritorious students.
							<br><br>
							<b>Values</b> :
							<br>
							<ul id="right_ul" class="ul_gap">
								<li><b>D</b>ignity</li>
								<li>Excellence</li>
								<li><b>D</b>iversity</li>

								<li><b>I</b>ndividual and team work</li>
