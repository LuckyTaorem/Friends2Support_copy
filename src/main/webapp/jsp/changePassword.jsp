	...
	<body>
		<% if(session.getAttribute("userid")==null){ session.invalidate(); response.sendRedirect("main.jsp?q=logout"); }
			...
			<div id="result_container">
				<% if(request.getParameter("q")!=null){ String q=request.getParameter("q"); switch(q){
					case "pass_notMatch" : out.println("<h3 class='alert_danger'>Password Does not Match!</h3>");
					break;
					case "success":
					...
					<div id="result_right" style="width:665px;">
						<div id="result_right_top">
							<div id="top"><a style="color:white;">&#9654;</a> <a>Change Password Page</a>
							</div>
							<div id="changePass">
								<form action="../changepass" method="post">
									<table style="font-size:12px;margin:auto;padding:10px;">
										...
										<tr>
											<td><input type="hidden" value="<% out.println(session.getAttribute("userid")); %>" name="id"></td>
